...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-rcppparallel-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-rcppparallel-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add r-rcppparallel
# for installing globally
pixi global install r-rcppparallel
```
...
It is possible to list all of the versions of `r-rcppparallel` available on your platform:
...
```
pixi search r-rcppparallel --channel conda-forge
```
